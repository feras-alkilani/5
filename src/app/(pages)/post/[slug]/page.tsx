...
import { getRelatedPosts } from "@/lib/post";
...
import AuthorSection from "@/components/authors-section";
...
export async function generateMetadata({
  ...
  if (!post) {
    return {
      ...
      description: `The article you are looking for does not exist or has been modified.`
    };
  }
      ...
      <div className="grid md:grid-cols-3 gap-8 md:gap-12">
        ...
        <section className="md:col-span-2 space-y-8 md:space-y-12">
          <div className="space-y-2 md:space-y-4">
            ...
            <small> Duration to read the article:{post.readTime} minutes</small>
          </div>
