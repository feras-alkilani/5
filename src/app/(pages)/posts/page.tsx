...
export const metadata: Metadata = {
  title: "My Blog Articles: Discover Diverse and Useful Topics",
  description:
    "Browse my blog articles to find sources of inspiration and valuable information on a wide variety of topics, including travel, culture, technology, food, and more, contributing to enriching your knowledge and broadening your horizons."
};
